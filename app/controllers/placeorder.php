...
$staff_email = 'qrnerstore2.0@gmail.com';
$customer_email = $_SESSION['user']['email'];          //
$subject = 'Qrnerstore Phils - Order Confirmation';
...
try {
    ...
    $mail->Password = 'qrnerstore123';                     // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom($staff_email, 'Qrnerstore');
